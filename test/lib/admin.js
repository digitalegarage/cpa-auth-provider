...
describe('GET /admin', function () {
    ...
    context('When the user is not authenticated', function () {
        ...
        it('should redirect to the login page', function () {
            ...
            expect(self.res.headers.location).to.equal(urlPrefix + "/responsive/login?redirect=/ap/admin");
        });
    });
});
...
describe('GET /admin/domains', function () {
    ...
    context('When the user is not authenticated', function () {
        ...
        it('should redirect to the login page', function () {
            ...
            expect(this.res.headers.location).to.equal(urlPrefix + "/responsive/login?redirect=/ap/admin/domains");
        });
    });
});
...
describe('GET /admin/domains/add', function () {
    ...
    context('When the user is not authenticated', function () {
        ...
        it('should redirect to the login page', function () {
            var urlPrefix = requestHelper.urlPrefix;
            expect(this.res.statusCode).to.equal(302);
            expect(this.res.headers.location).to.equal(urlPrefix + "/responsive/login?redirect=/ap/admin/domains/add");
        });
    });
});
