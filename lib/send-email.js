                ...
                ses.sendEmail(
                    {
                        ...
                        Message: {
                            Subject: {
                                Data: 'EV Content Discovery - Account Creation',
                                Charset: 'utf8'
                            },
                            Body: {
                                Html: {
                ...
                ses.sendEmail(
                    {
                        ...
                        Message: {
                            Subject: {
                                Data: 'EV Content Discovery - Set Password',
                                Charset: 'utf8'
                            },
                            Body: {
                                Html: {
                ...
                ses.sendEmail(
                    {
                        ...
                        Message: {
                            Subject: {
                                Data: 'EV Content Discovery - Delete Account',
                                Charset: 'utf8'
                            },
                            Body: {
                                Html: {
                ...
                ses.sendEmail(
                    {
                        ...
                        Message: {
                            Subject: {
                                Data: 'EV Content Discovery - Delete Account aufgehoben',
                                Charset: 'utf8'
                            },
                            Body: {
                                Html: {
