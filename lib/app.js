...
app.use(function (req, res, next) {
    ...
    if (config.alternate_security_token_header_name && req.headers && req.headers[config.alternate_security_token_header_name]) {
        var cookies = req.headers.cookie;
        if (!cookies) {
            req.headers.cookie = config.auth_session_cookie.name + '=' + req.headers[config.alternate_security_token_header_name];
        } else {
            ...
            headersString += config.auth_session_cookie.name + '=' + req.headers[config.alternate_security_token_header_name];
