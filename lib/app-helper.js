...
appHelper.headerHelper = function(app,logger) {
  ...
  app.use(function(req,res,next) {
    ...
    if (config.use_secure_headers != false) {
      ...
      res.append('Content-Security-Policy', 'default-src https: \'self\'; script-src https: \'self\'; style-src https: \'self\'; img-src *; frame-src \'self\'; connect-src https:; report-uri /csp_report;');
