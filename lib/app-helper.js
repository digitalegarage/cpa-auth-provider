...
appHelper.headerHelper = function(app,logger) {
  ...
  app.use(function(req,res,next) {
    ...
    if (config.use_secure_headers != false) {
      res.append('X-XSS-Protection', '1; mode=block');
      res.append('X-Content-Type-Options', 'nosniff');
      res.append('Strict-Transport-Security', 'max-age=31536000');
      res.append('Content-Security-Policy', 'default-src data: https: \'self\'; script-src https: \'self\' \'unsafe-inline\' http://connect.facebook.com/; style-src https: \'self\' \'unsafe-inline\'; img-src *; frame-src \'self\' http://staticxx.facebook.com https://www.google.com https://accounts.google.com/; connect-src https:; font-src: \'self\' \'data\'');
